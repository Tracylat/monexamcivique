  ...
  return (
    <>
      ...
      {purchasedPlans.length === 0 && (
        <div className="max-w-[1200px] mx-auto px-4 py-5 sm:px-6 sm:py-6">
      ...
      {/* Encouragement Toast */}
      {encouragement && (
        <div className="fixed top-20 right-3 sm:right-8 bg-white p-4 sm:p-6 rounded-xl shadow-2xl z-50 animate-bounce border-l-4 border-[#1a4d8f] max-w-[92vw] sm:max-w-sm">
      ...
      {view === 'selection' && (
        <div className="max-w-[1200px] mx-auto p-4 sm:p-6 lg:p-8">
          <div className="max-w-[900px] mx-auto py-8 px-2 sm:py-12 sm:px-6 lg:py-16 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="font-heading text-3xl sm:text-5xl font-extrabold text-[#0f3466] mb-4">Quel titre de séjour demandez-vous ?</h2>
              <p className="text-base sm:text-xl text-gray-600">Sélectionnez pour un test adapté à VOTRE niveau</p>
            </div>
            <div className="grid grid-cols-[repeat(auto-fit,minmax(280px,1fr))] gap-8 mt-12">
              <div className="bg-white rounded-2xl p-10 shadow-[0_8px_24px_rgba(0,0,0,0.08)] transition-all cursor-pointer border-2 border-transparent hover:-translate-y-2 hover:shadow-[0_16px_40px_rgba(0,0,0,0.12)] hover:border-[#1a4d8f]" onClick={() => startQuiz('CSP')}>
                ...
                <div className="font-heading text-2xl sm:text-3xl font-bold text-[#1a4d8f] mb-2">Carte de Séjour Pluriannuelle</div>
                <p className="text-gray-600 mb-4">Durée : 2 à 4 ans</p>
                <div className="bg-[#eef4ff] p-4 rounded-lg text-sm"><strong>Niveau :</strong> Questions standard</div>
              </div>
              <div className="bg-white rounded-2xl p-10 shadow-[0_8px_24px_rgba(0,0,0,0.08)] transition-all cursor-pointer border-2 border-transparent hover:-translate-y-2 hover:shadow-[0_16px_40px_rgba(0,0,0,0.12)] hover:border-[#1a4d8f]" onClick={() => startQuiz('Résident')}>
                <div className="text-5xl sm:text-6xl text-center mb-4">🏡</div>
                <div className="font-heading text-2xl sm:text-3xl font-bold text-[#1a4d8f] mb-2">Carte de Résident</div>
                <p className="text-gray-600 mb-4">Durée : 10 ans</p>
                <div className="bg-[#eef4ff] p-4 rounded-lg text-sm"><strong>Niveau :</strong> Questions avancées ⚠️</div>
              </div>
              <div className="bg-white rounded-2xl p-10 shadow-[0_8px_24px_rgba(0,0,0,0.08)] transition-all cursor-pointer border-2 border-transparent hover:-translate-y-2 hover:shadow-[0_16px_40px_rgba(0,0,0,0.12)] hover:border-[#1a4d8f]" onClick={() => startQuiz('Naturalisation')}>
                <div className="text-5xl sm:text-6xl text-center mb-4">🇫🇷</div>
                <div className="font-heading text-2xl sm:text-3xl font-bold text-[#1a4d8f] mb-2">Naturalisation</div>
      ...
      {view === 'quiz' && (
        <div className="max-w-[1200px] mx-auto p-4 sm:p-6 lg:p-8">
          <div className="bg-gradient-to-br from-[#1a4d8f] to-[#0f3466] text-white p-6 sm:p-10 lg:p-12 rounded-[20px] text-center mb-8 sm:mb-12">
            <h2 className="font-heading text-3xl sm:text-5xl font-extrabold mb-4">ÉVALUATION GRATUITE</h2>
            <p className="text-base sm:text-xl mt-4">Testez vos chances de réussite</p>
          ...
          <div className="bg-white rounded-2xl p-5 sm:p-8 lg:p-12 shadow-[0_8px_24px_rgba(0,0,0,0.08)] mb-8">
            <div className="font-heading text-[#d72638] font-bold text-lg mb-4 uppercase tracking-wider">
            ...
            <div className="grid gap-4">
              {questionsByLevel[selectedTitle][currentQuestionIndex].answers.map((answer, idx) => (
                <div 
                  key={idx}
                  className={`p-4 sm:p-6 border-2 rounded-xl cursor-pointer transition-all text-base sm:text-lg font-medium flex items-start sm:items-center
                ...
                >
                  <div className={`w-6 h-6 rounded-full border-2 mr-3 sm:mr-4 mt-0.5 sm:mt-0 flex items-center justify-center shrink-0
      ...
      {view === 'results' && (
        <div className="max-w-[1200px] mx-auto p-4 sm:p-6 lg:p-8">
          <div className="bg-white rounded-2xl p-5 sm:p-8 lg:p-12 shadow-[0_8px_24px_rgba(0,0,0,0.08)] text-center max-w-[800px] mx-auto mb-8">
            <h2 className="font-heading text-2xl sm:text-4xl text-gray-600">Votre score</h2>
            ...
            <div className={`font-bold text-xl uppercase tracking-wider mb-6 ${
              quizScore >= 8 ? 'text-[#1a4d8f]' : quizScore >= 5 ? 'text-[#d72638]' : 'text-[#d32f2f]'
            }`}>
              {quizScore >= 8 ? '✅ BON NIVEAU' : quizScore >= 5 ? '⚠️ NIVEAU MOYEN' : '⚠️ NIVEAU INSUFFISANT'}
            </div>
            <p className="mt-6 text-base sm:text-lg text-gray-600">Score minimum requis : <strong>32/40 (80%)</strong> à l'examen officiel</p>
          </div>

          <div className="bg-[#fff5f5] border-l-4 border-[#d32f2f] p-5 sm:p-8 rounded-r-lg max-w-[800px] mx-auto mb-12">
            <h3 className="text-[#d32f2f] font-bold text-xl mb-2">⚠️ Attention : Risque d'échec élevé</h3>
            <p className="text-base sm:text-xl leading-relaxed">Avec ce score, votre examen en préfecture présente un <strong>risque d'échec très élevé</strong>. Conséquences : dossier bloqué, projet de vie retardé de 6+ mois.</p>
          </div>

          <div className="bg-gradient-to-br from-[#f0f9ff] to-[#eef4ff] border-l-4 border-[#1a4d8f] rounded-xl p-5 sm:p-8 my-8 max-w-[800px] mx-auto">
            <h4 className="font-heading text-[#1a4d8f] text-2xl sm:text-3xl mb-4">💡 Le saviez-vous ?</h4>
            <p className="text-base sm:text-lg leading-relaxed mb-6">Un examen raté coûte 10x plus cher qu'une préparation sérieuse.</p>
            <div className="flex gap-4 flex-wrap">
              ...
              <div className="flex-1 bg-white p-6 rounded-xl shadow-sm border border-[#dbeafe]">
                <div className="font-semibold text-[#1a4d8f] mb-4">✓ Avec Examen Civique Etrangers</div>
          ...
          <div className="text-center mt-12">
            ...
            <p className="text-gray-600 mt-4 text-sm sm:text-base">✓ Fiches révision interactives • Répétition espacée<br/>✓ Examens blancs 45min • Statistiques détaillées<br/>✓ Certificat de réussite PDF • Garantie satisfait ou remboursé</p>
          </div>
        </div>
      )}
      ...
      {view === 'dashboard' && (
        <div className="max-w-[1200px] mx-auto p-4 sm:p-6 lg:p-8">
          ...
          <div className="bg-white rounded-2xl p-5 sm:p-8 shadow-[0_4px_12px_rgba(0,0,0,0.05)] flex flex-col sm:flex-row items-start gap-6 mb-6">
            <div className="text-3xl sm:text-5xl bg-[#eef4ff] w-16 h-16 rounded-full flex items-center justify-center">📚</div>
            <div className="flex-1">
              <div className="font-heading text-2xl sm:text-3xl font-bold text-[#1a4d8f] mb-2">1. Fiches de révision par thème</div>
              ...
              <div className="bg-gray-200 rounded-full h-2 w-full mb-4">
                <div className="bg-[#1a4d8f] h-2 rounded-full transition-all" style={{ width: `${(masteredCardsCount/100)*100}%` }}></div>
              </div>
          ...
          <div className="bg-white rounded-2xl p-5 sm:p-8 shadow-[0_4px_12px_rgba(0,0,0,0.05)] flex flex-col sm:flex-row items-start gap-6 mb-6">
            <div className={`text-3xl sm:text-5xl w-16 h-16 rounded-full flex items-center justify-center ${masteredCardsCount >= 50 ? 'bg-[#eef4ff]' : 'bg-gray-100 grayscale opacity-50'}`}>✍️</div>
            <div className="flex-1">
              <div className="font-heading text-2xl sm:text-3xl font-bold text-[#1a4d8f] mb-2">2. Examens blancs (40 questions)</div>
              <div className="text-gray-600 mb-4">
                {masteredCardsCount >= 50 ? `🟢 Actif • ${examsPassedCount}/3 examens réussis` : '🔒 Débloqué après 50 fiches maîtrisées'}
              </div>
              <div className="bg-gray-200 rounded-full h-2 w-full mb-4">
                <div className="bg-[#1a4d8f] h-2 rounded-full transition-all" style={{ width: `${(examsPassedCount/3)*100}%` }}></div>
              </div>
              <button 
          ...
          <div className="bg-white rounded-2xl p-5 sm:p-8 shadow-[0_4px_12px_rgba(0,0,0,0.05)] flex flex-col sm:flex-row items-start gap-6 mb-6">
            <div className={`text-3xl sm:text-5xl w-16 h-16 rounded-full flex items-center justify-center ${examsPassedCount >= 3 ? 'bg-[#eef4ff]' : 'bg-gray-100 grayscale opacity-50'}`}>🏆</div>
            <div className="flex-1">
              <div className="font-heading text-2xl sm:text-3xl font-bold text-[#1a4d8f] mb-2">3. Certificat de réussite</div>
              <div className="text-gray-600 mb-4">
      ...
      {view === 'flashcards' && (
        <div className="max-w-[1200px] mx-auto p-4 sm:p-6 lg:p-8">
          <div className="max-w-[800px] mx-auto">
            <div className="bg-gradient-to-br from-[#1a4d8f] to-[#0f3466] text-white p-6 sm:p-8 rounded-[20px] mb-8 sm:mb-12 text-center">
              <h2 className="font-heading text-3xl sm:text-5xl font-extrabold mb-4">📚 Fiches de révision</h2>
              <p className="text-base sm:text-xl opacity-95">Thème : <span className="font-bold">{flashcards[currentFlashcardIndex]?.theme}</span></p>
              <div className="mt-6 text-base sm:text-lg">Carte <span className="font-bold">{currentFlashcardIndex + 1}</span>/100 • Maîtrisées : <span className="font-bold">{masteredCardsCount}</span></div>
            </div>

            <div 
              className="bg-white rounded-2xl p-0 shadow-[0_8px_24px_rgba(0,0,0,0.08)] min-h-[320px] sm:min-h-[400px] cursor-pointer relative"
            ...
            >
              {/* Front */}
              <div 
                className="w-full h-full p-5 sm:p-12 flex flex-col justify-center items-center rounded-2xl"
                style={{ 
              ...
              {/* Back */}
              <div 
                className="absolute w-full h-full p-5 sm:p-12 flex flex-col justify-center items-center bg-[#f0f9ff] rounded-2xl top-0 left-0"
                style={{ 
                  backfaceVisibility: 'hidden',
                  WebkitBackfaceVisibility: 'hidden',
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-3 sm:gap-4 mt-8">
              ...
              <button className="btn bg-[#1a4d8f] text-white hover:bg-[#0f3466]" onClick={handleCardMastered}>✅ Je savais</button>
            </div>
      ...
      {view === 'exam' && (
        <div className="max-w-[1200px] mx-auto p-4 sm:p-6 lg:p-8">
          <div className="bg-gradient-to-br from-[#1a4d8f] to-[#0f3466] text-white p-5 sm:p-8 rounded-[20px] mb-8 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            <div>
              <h2 className="font-heading text-2xl sm:text-4xl font-bold">EXAMEN BLANC</h2>
              <p className="text-lg mt-2">Format officiel : {examQuestions.length} questions • 45 minutes</p>
            </div>
            <div className={`text-3xl sm:text-5xl font-mono font-bold bg-white/20 px-6 py-2 rounded-lg ${examTimeRemaining < 300 ? 'text-[#d72638]' : ''}`}>
      ...
      {view === 'examResults' && (
        <div className="max-w-[1200px] mx-auto p-4 sm:p-6 lg:p-8">
          <div className="bg-white rounded-2xl p-5 sm:p-8 lg:p-12 shadow-[0_8px_24px_rgba(0,0,0,0.08)] text-center max-w-[800px] mx-auto mb-8">
            <h2 className="font-heading text-2xl sm:text-4xl text-gray-600">Résultat de l'examen blanc</h2>
            <div className="font-heading text-5xl sm:text-7xl font-extrabold text-[#1a4d8f] my-4">{examScore}/{examQuestions.length}</div>
            <div className={`font-bold text-xl uppercase tracking-wider mb-6 ${examScore >= getPassingScore(examQuestions.length) ? 'text-[#1a4d8f]' : 'text-[#d32f2f]'}`}>
              {examScore >= getPassingScore(examQuestions.length) ? '✅ RÉUSSI' : '❌ ÉCHOUÉ'}
            </div>
            <p className="mt-6 text-base sm:text-lg text-gray-600">Temps écoulé : <strong>{formatTime((45*60) - examTimeRemaining)}</strong></p>
      ...
      {view === 'certificate' && (
        <div className="max-w-[1200px] mx-auto p-4 sm:p-6 lg:p-8">
          <div className="bg-white p-5 sm:p-10 lg:p-16 rounded-2xl shadow-xl border-4 sm:border-[10px] border-[#1a4d8f] text-center max-w-[900px] mx-auto relative overflow-hidden">
            <div className="absolute top-0 left-0 w-20 h-20 sm:w-32 sm:h-32 bg-[#1a4d8f] transform -translate-x-10 sm:-translate-x-16 -translate-y-10 sm:-translate-y-16 rotate-45"></div>
            <div className="absolute bottom-0 right-0 w-20 h-20 sm:w-32 sm:h-32 bg-[#1a4d8f] transform translate-x-10 sm:translate-x-16 translate-y-10 sm:translate-y-16 rotate-45"></div>
            
            <div className="text-5xl sm:text-6xl mb-4">🏆</div>
            <h1 className="font-heading text-4xl sm:text-6xl font-bold text-[#1a4d8f] mb-2 tracking-widest">CERTIFICAT</h1>
            <h2 className="font-heading text-2xl sm:text-4xl font-bold text-[#d72638] mb-8 uppercase tracking-widest">De Réussite</h2>
            
            <p className="text-base sm:text-xl text-gray-600 mb-8">Ce certificat atteste que</p>
            <div className="font-heading text-5xl sm:text-6xl font-bold text-[#1a1a1a] mb-8 border-b-2 border-gray-200 inline-block px-4 sm:px-12 pb-2 break-words">
              [Votre Nom]
            </div>
            ...
            <p className="text-sm sm:text-base text-gray-500">Délivré le {new Date().toLocaleDateString()} par Examen Civique Etrangers</p>
          </div>

          <div className="text-center mt-8">
            <button className="btn btn-primary" onClick={() => window.print()}>📥 Télécharger le certificat PDF</button>
            <button className="btn bg-gray-600 text-white mt-3 sm:mt-0 sm:ml-4" onClick={() => setView('dashboard')}>Retour au tableau de bord</button>
          </div>
        </div>
      )}
        </>
