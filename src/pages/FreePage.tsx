      ...
      {view === 'quiz' && (
        <div className="max-w-[1200px] mx-auto p-8">
          <div className="bg-gradient-to-br from-[#1a4d8f] to-[#0f3466] text-white p-12 rounded-[20px] text-center mb-12">
            <h2 className="font-heading text-[2.8rem] font-extrabold mb-4">📚 {tr('ÉVALUATION GRATUITE', 'FREE ASSESSMENT')}</h2>
            <p className="text-[1.3rem] mt-4">{tr('Testez vos chances de réussite', 'Test your chances of success')}</p>
      ...
      {view === 'results' && (
        <div className="max-w-[1200px] mx-auto p-8">
          <div className="bg-white rounded-2xl p-12 shadow-[0_8px_24px_rgba(0,0,0,0.08)] text-center max-w-[800px] mx-auto mb-8">
            <h2 className="font-heading text-[2rem] text-gray-600">{tr('Votre score', 'Your score')}</h2>
          ...
          <div className="bg-gradient-to-br from-[#f0f9ff] to-[#e0f2fe] border-l-4 border-[#1a4d8f] rounded-xl p-8 my-8 max-w-[800px] mx-auto">
            <h4 className="font-heading text-[#1a4d8f] text-[1.5rem] mb-4">💡 {tr('Vous voulez vraiment réussir ?', 'Do you really want to succeed?')}</h4>
            <p className="text-[1.1rem] leading-relaxed mb-6">{tr("Débloquez l'accès complet avec 200+ questions de révision, 5 examens blancs et des fiches interactives.", 'Unlock full access with 200+ review questions, 5 mock exams and interactive cards.')}</p>
