  ...
  fr: {
    translation: {
      ...
      landing: {
        ...
        urgencyCost: "Échec = 225 EUR + 6 mois d'attente",
        heroTitle1: 'Réussissez votre',
        heroTitle2: 'examen civique',
        heroTitle3: 'du premier coup',
        heroSubtitle:
          '641 questions, examens blancs chronométrés et mises en situation réelles. La préparation la plus complète pour obtenir votre titre de séjour.',
        statQuestions: '641 questions',
        statSuccess: '97 % de réussite',
        statReady: 'Prêt en 3 semaines',
        ctaStart: 'Tester mon niveau',
      ...
      auth: {
        ...
        loginSubtitle: 'Retrouvez votre progression et continuez votre préparation.',
        ...
        backendCheck: 'Impossible de joindre le serveur. Vérifie que le backend tourne.',
      },
    },
  },
  en: {
