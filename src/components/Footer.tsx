      ...
      <footer className="bg-[#1a4d8f] text-white pt-12 sm:pt-16 pb-8 px-4 sm:px-6 lg:px-8 mt-auto">
        <div className="max-w-[1200px] mx-auto grid grid-cols-1 lg:grid-cols-[1.5fr_1fr_1fr] gap-8 lg:gap-12 mb-12 sm:mb-16">
          ...
          <div>
            ...
            <div className="mt-8">
              <h4 className="font-heading text-sm font-bold uppercase tracking-wider text-white/90 mb-3">Langue</h4>
              <LanguageSwitcher />
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-white/10 pt-5">
          <div className="max-w-[1200px] mx-auto flex flex-col lg:flex-row items-start lg:items-center justify-between gap-3">
            <div className="text-sm text-white/70">© 2026 Examen Civique Etrangers - Tous droits réservés</div>
            <div className="w-full lg:w-auto">
              <div className="flex flex-wrap items-center gap-2 text-[12px] text-white/90">
                <span className="rounded-md border border-white/20 bg-white/10 px-2 py-1">🔒 Paiement sécurisé</span>
                <span className="rounded-md border border-white/20 bg-white/10 px-2 py-1">✅ SSL Certifié</span>
                <span className="rounded-md border border-white/20 bg-white/10 px-2 py-1">🛡️ RGPD</span>
                <span className="rounded-md border border-white/20 bg-white/10 px-2 py-1"><span className="text-[#fbbf24]">★★★★★</span> 4.9/5</span>
              </div>
              <div className="mt-2 flex flex-wrap items-center gap-2 text-[11px] font-bold text-[#0f3466]">
                <span className="inline-flex h-7 w-12 items-center justify-center rounded bg-white">VISA</span>
                <span className="inline-flex h-7 w-12 items-center justify-center rounded bg-white">MC</span>
                <span className="inline-flex h-7 w-12 items-center justify-center rounded bg-white">AMEX</span>
                <span className="inline-flex h-7 w-12 items-center justify-center rounded bg-white text-[9px] leading-none">Apple<br/>Pay</span>
                <span className="inline-flex h-7 w-12 items-center justify-center rounded bg-white text-[9px] leading-none">Google<br/>Pay</span>
              </div>
            </div>
          </div>
        </div>
